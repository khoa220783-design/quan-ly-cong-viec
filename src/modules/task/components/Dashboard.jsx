...
const Dashboard = () => {
    return (
        <div className="space-y-8 animate-fade-in">
            {/* Welcome Banner */}
            <div className="relative overflow-hidden bg-surface-elevated border border-border rounded-2xl p-8 group">
                <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
                    <FaRocket className="w-24 h-24 text-neon-green -rotate-12" />
                </div>
